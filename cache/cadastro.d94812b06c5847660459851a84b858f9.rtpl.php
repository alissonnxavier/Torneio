...
<div class="container" style="width: 40rem" style="font-family: Impact, Charcoal, sans-serif;"><br>
	...
	<form action="/slim/cadastrado" method="post" enctype="multipart/form-data" style="font-family: Impact, Charcoal, sans-serif;">
		...
		<div class="input-group flex-nowrap">
			  ...
			  <input type="text" class="form-control" placeholder="Crie uma senha" aria-label="Username" aria-describedby="addon-wrapping" required="" name="password">
		</div><br>
