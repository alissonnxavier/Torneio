...
<!--
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12">
                            ...
                            <div class="Games">
                                ...
                                <?php if( $var["3"]>=2 ){ ?>
                                <div class="alert alert-danger" role="alert" style="font-family: Impact, Charcoal, sans-serif;">
                                    Vagas encerradas!
                                </div>
                                <?php } ?>
     ...
     -->          
                <?php $counter1=-1;  if( isset($var["4"]) && ( is_array($var["4"]) || $var["4"] instanceof Traversable ) && sizeof($var["4"]) ) foreach( $var["4"] as $key1 => $value1 ){ $counter1++; ?>
                <?php if( $var["5"]==data($value1["data"]) ){ ?>

                <form action="/slim/inscrito" method="post">
                    <div class="row">
                        <div class="col-md-12 margin_bottom">
                            <div class="row">
                                ...
                                <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12">
                                    ...
                                    <div class="Games">
                                        ...
                                        <input type="text" name="cv" hidden="" value="<?php echo htmlspecialchars( $value1["niveldocv"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                                        <h3>Torneio de cv <?php echo htmlspecialchars( $value1["niveldocv"], ENT_COMPAT, 'UTF-8', FALSE ); ?></h3>

                                        <input type="" name="idtorneio" hidden="" value="<?php echo htmlspecialchars( $value1["idtorneio"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">

                                        <h4>Data</h4>
                                        <h5><?php echo data($value1["data"]); ?></h5><br>

                                        <h4>Horario do torneio</h4>
                                        <h5><?php echo htmlspecialchars( $value1["hora"], ENT_COMPAT, 'UTF-8', FALSE ); ?></h5>                                


                                        <?php if( $var["1"]==$value1["idtorneio"] ){ ?>
                                        <div class="alert alert-success" role="alert" style="font-family: Impact, Charcoal, sans-serif;">
                                            Voce esta inscrito para este torneio!
                                        </div>
                                        <?php } ?>
                                        ...
                                        <?php if( $var["1"]!=$value1["idtorneio"] ){ ?>
                                        <?php if( $var["3"]<2 ){ ?>
                                        <button class="btn btn-outline-warning">Inscrever-se</button>
                                        <?php } ?>
                                        <?php } ?>

                                        <button class="btn btn-outline-info">Ver tabela</button>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td rowspan="2" style="border:1px solid #aaa;" bgcolor="#f9f9f9">&nbsp;<b><span class="flagicon"><a href="/wiki/Brasil" title="Brasil">
                    ...
                    <?php if( $var["2"]!='a' ){ ?>
                    <?php echo htmlspecialchars( $var["2"]["0"]["nomedojogador"], ENT_COMPAT, 'UTF-8', FALSE ); ?>
                    <?php } ?>

                    <form action="/slim/quartasdefinais" method="post">
                        
                            <input type="" value="<?php echo htmlspecialchars( $var["2"]["0"]["idjogador"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" name="num" hidden="">
                            <input class="btn btn-success" type="submit" name="">
                    </form>

                </td>
                <td rowspan="2" align="center" style="border:1px solid #aaa;" bgcolor="#f9f9f9">&nbsp;<span style="white-space:nowrap;"></span><?php echo htmlspecialchars( $var["2"]["0"]["idjogador"], ENT_COMPAT, 'UTF-8', FALSE ); ?>
                </td>
